...
public class Tower2 implements ITower {
    ...
    private final Image image = new Image("https://thumbs.dreamstime.com/b/sailor-lighthouse-character-cartoon-style"
    ...
    private int x;
    private int y;
    private String name = "Black Tower";

    public Tower2(Player p) {
        this.atkDamage = 25;
        this.atkSpeed = 0.5;
        this.atkRange = 1;
    ...
    public Tower2(Player p, int x, int y) {
        this.atkDamage = 20;
        this.atkSpeed = 0.5;
        this.atkRange = 1;
        this.x = x;
