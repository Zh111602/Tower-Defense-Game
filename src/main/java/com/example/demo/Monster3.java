...
public class Monster3 implements IMonster {
    private int health;
    ...
    private int x;
    private int y;
    private final Image image = new Image("https://www.pinclipart.com"
            + "/picdir/big/161-1618287_stickers-by-smart-messages-cartoon"
            + "-zombie-head-png.png");
    public Monster3() {
        this.health = 150;
